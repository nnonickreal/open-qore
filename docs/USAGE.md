...
1.  **your firmware dump:** currently, you must have a [firmware dump](READING.md) from your **own** pair of headphones. flashing a firmware dump from another device can lead to malfunctions, as some calibration data is unique to each unit.
